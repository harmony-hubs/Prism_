import{B as e,C as t,g as n,j as r,r as i,u as a,y as o,z as s}from"./ModalController-DjvkFNzA.js";import{S as c,d as l,h as u,l as d,n as f,o as p,t as m}from"./exports-C4ES4Tdq.js";import{o as h,s as g}from"./wui-text-BxBjgbjC.js";import{t as _}from"./if-defined-Da5l0At8.js";import"./wui-image-BayAukO8.js";import"./wui-icon-box-CLH3jmFq.js";import"./wui-shimmer-CcWjrg4S.js";import"./wui-link-osyB4sxS.js";import"./wui-icon-box-BAFb59fK.js";var v;(function(e){e.approve=`approved`,e.bought=`bought`,e.borrow=`borrowed`,e.burn=`burnt`,e.cancel=`canceled`,e.claim=`claimed`,e.deploy=`deployed`,e.deposit=`deposited`,e.execute=`executed`,e.mint=`minted`,e.receive=`received`,e.repay=`repaid`,e.send=`sent`,e.sell=`sold`,e.stake=`staked`,e.trade=`swapped`,e.unstake=`unstaked`,e.withdraw=`withdrawn`})(v||={});var y=d`
  :host > wui-flex {
    display: flex;
